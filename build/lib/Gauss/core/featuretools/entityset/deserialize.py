...
from Gauss.core.featuretools.entityset.relationship import Relationship
from Gauss.core.featuretools.entityset.serialize import FORMATS
from Gauss.core.featuretools.utils.gen_utils import check_schema_version, import_or_raise
from Gauss.core.featuretools.utils.s3_utils import get_transport_params, use_smartopen_es
from Gauss.core.featuretools.utils.wrangle import _is_local_tar, _is_s3, _is_url
from Gauss.core.featuretools.variable_types import LatLong, find_variable_types
...
def description_to_entityset(description, **kwargs):
    ...
    from Gauss.core.featuretools.entityset import EntitySet
