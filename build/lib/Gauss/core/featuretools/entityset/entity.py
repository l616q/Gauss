...
from Gauss.core.featuretools import variable_types as vtypes
from Gauss.core.featuretools.utils.entity_utils import (
    col_is_datetime,
...
from Gauss.core.featuretools.utils.wrangle import _check_time_type, _dataframes_equal
from Gauss.core.featuretools.variable_types import Text, find_variable_types
...
class Entity(object):
    ...
    def convert_variable_type(self, variable_id, new_type,
        ...
        Examples:
            >>> from core.featuretools import make_ecommerce_entityset
