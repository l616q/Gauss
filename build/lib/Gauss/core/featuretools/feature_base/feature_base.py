from Gauss.core.featuretools import Relationship, Timedelta
from Gauss.core.featuretools import primitives
...
from Gauss.core.featuretools.primitives.utils import serialize_primitive
from Gauss.core.featuretools.utils.wrangle import (
    _check_time_against_column,
    _check_timedelta
)
from Gauss.core.featuretools.variable_types import (
    Boolean,
    Categorical,
    Datetime,
    DatetimeTimeIndex,
