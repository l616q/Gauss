...
from Gauss.utils.yaml_exec import yaml_read, yaml_write
from Gauss.pipeline.local_pipeline.inference import Inference
from Gauss.utils.Logger import logger
from Gauss.utils.bunch import Bunch


# test programming
pipeline_dict = yaml_read(yaml_file="/home/liangqian/Gauss/experiments/0Ay7Oi/pipeline_configure.yaml")
...
pipeline_dict["inference_data_path"] = "/home/liangqian/文档/公开数据集/bank/bank_infer.txt"
