...
class CoreRoute(Component):
    def __init__(self,
       ...
       self.model = ModleFactory(model_type, model_configure_root, model_save_root, train_flag, metric_type, task_type...)
