...
from Gauss.entity.metrics.base_metric import MetricResult
from Gauss.entity.model.model import ModelWrapper

from Gauss.gauss.feature_select.base_feature_selector import BaseFeatureSelector

from Gauss.core.nni.algorithms.feature_engineering.gradient_selector import FeatureGradientSelector
from Gauss.core.nni.algorithms.feature_engineering.gbdt_selector import GBDTSelector
from Gauss.core.nni.algorithms.hpo.hyperopt_tuner import HyperoptTuner
...
class SupervisedFeatureSelector(BaseFeatureSelector):
    ...
    def __check_dataset(cls, dataframe: pd.DataFrame):
        ...
        features = indices_to_keep[indices_to_keep].index
