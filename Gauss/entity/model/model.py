...
from Gauss.entity.entity import Entity
...
from Gauss.utils.feature_name_exec import generate_feature_list, generate_categorical_list
    ...
    def __init__(self, **params):
        ...
        if self._train_flag == ConstantValues.train:
            ...
            if self._init_model_root is not None:
                self._init_model_path = os.path.join(self._init_model_root, ConstantValues.model)
